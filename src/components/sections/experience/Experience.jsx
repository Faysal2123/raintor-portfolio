    ...
    <div className="w-11/12 mx-auto">
      ...
      <div className="pt-20 flex flex-col md:flex-row gap-10 mx-auto px-4 lg:w-[1600px]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 grid-rows-2 gap-6 w-full">
          ...
          <div className="border rounded-full lg:-mr-10 flex items-center justify-center h-20 px-6 hover:bg-black hover:text-white font-bold text-base transition-all duration-300 shadow-md">
            facebook
          </div>
          <div className="border rounded-full rotate-12 flex items-center justify-center h-20 px-6 hover:bg-black hover:text-white font-bold text-base transition-all duration-300 shadow-md">
